  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="navbarCollapse">
      <ul class="navbar-nav me-auto mb-2 mb-md-0">
        ...
        <li class="nav-item">
          <a class="nav-link <?php echo !empty($Client)?"active":""?>" href="Client.php" tabindex="-1">Clients</a>
        </li>
        <li class="nav-item">
          <a class="nav-link <?php echo !empty($Commande)?"active":""?>" href="Commande.php" tabindex="-1">Commandes</a>
        </li>
        <li class="nav-item">
